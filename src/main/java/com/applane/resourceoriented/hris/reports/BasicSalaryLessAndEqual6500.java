...
public class BasicSalaryLessAndEqual6500 extends HttpServlet {
	...
	private void graduativityReport(HttpServletRequest req, HttpServletResponse resp) {
		...
		String decompositionParameter = "attachment;filename=Gross_Salary_Less_And_Equal_6500_Report.xls";
