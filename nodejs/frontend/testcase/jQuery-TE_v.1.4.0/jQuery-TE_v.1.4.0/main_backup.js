...
webApp.directive('appRichTextBox', ["$compile", function ($compile) {
    return {
        restrict:"E",
        replace:true,
        scope:true,
        ...
        compile:function () {
            return{
                pre:function ($scope, iElement, attrs) {
                    ...
                    var textareaTemplate = '<textarea name="textarea" ng-model='+toBind+'></textarea>';
...
//                                $scope[attrs.model][attrs.field] = thisElement.val();
//
//                                if (!$scope.$$phase) {
//                                    $scope.$apply();
//                                }
...
//                                editor.html(extractToText(thisElement.val()));
                            ...
                            editor
                                ...
                                .focusout(function () {                                     // the event of focus out from the text field
