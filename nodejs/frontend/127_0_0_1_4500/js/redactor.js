(function($)
{
	...
	$.Redactor.opts = {
			...
			buttonsCustom: {},
			buttonsAdd: [],
			buttons: ['html', '|', 'formatting', '|', 'bold', 'italic', 'deleted', '|', 'unorderedlist', 'orderedlist', 'outdent', 'indent', '|', 'image','table', 'link', '|', 'fontcolor', 'backcolor', '|', 'alignment', '|'], // 'underline', 'alignleft', 'aligncenter', 'alignright', 'justify'
	...
	Redactor.fn = $.Redactor.prototype = {
		...
		linkShow: function()
		{
			...
			var callback = $.proxy(function()
			{
				...
				if (this.opts.linkAnchor === false) tabs.eq(1).remove();
